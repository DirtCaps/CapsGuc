...
Function DisableTelemetry {
	Write-Output "Telemetry Devredisi..."
...
Function DisableWiFiSense {
	Write-Output "Wi-Fi Sense Devredisi..."
...
Function EnableWiFiSense {
	Write-Output "Wi-Fi Sense Aktif!"
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting" -Force | Out-Null
	}
...
Function DisableSmartScreen {
	Write-Output "SmartScreen Devredisi..."
...
Function DisableWebSearch {
	Write-Output "Arama Bing Devredisi..."
...
Function DisableAppSuggestions {
	Write-Output "Program Ayarlari Devredisi..."
...
Function EnableAppSuggestions {
	Write-Output "Program Ayarlari Aktif!"
...
Function DisableBackgroundApps {
	Write-Output "Arkaplan Uygulamalari Devredisi..."
...
Function EnableBackgroundApps {
	Write-Output "Arkaplan Uygulamalari Aktif!"
...
Function DisableMapUpdates {
	Write-Output "Harita Guncelleme Devredisi..."
	Set-ItemProperty -Path "HKLM:\SYSTEM\Maps" -Name "AutoUpdateEnabled" -Type DWord -Value 0
}

# Enable automatic Maps updates
Function EnableMapUpdates {
	Write-Output "Harita Guncelleme Aktif!"
	Remove-ItemProperty -Path "HKLM:\SYSTEM\Maps" -Name "AutoUpdateEnabled" -ErrorAction SilentlyContinue
}

# Disable Feedback
Function DisableFeedback {
	Write-Output "Feedback Devredisi..."
...
Function DisableTailoredExperiences {
	Write-Output "Tailored Experiences Devredisi..."
...
Function EnableTailoredExperiences {
	Write-Output "Tailored Experiences Aktif!"
	Remove-ItemProperty -Path "HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent" -Name "DisableTailoredExperiencesWithDiagnosticData" -ErrorAction SilentlyContinue
}

# Disable Advertising ID
Function DisableAdvertisingID {
	Write-Output "Advertising ID Devredisi..."
...
Function EnableAdvertisingID {
	Write-Output "Advertising ID Aktif!"
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AdvertisingInfo" -Name "DisabledByGroupPolicy" -ErrorAction SilentlyContinue
}

# Disable Cortana
Function DisableCortana {
	Write-Output "Cortana Devredisi..."
...
Function DisableOneDrive {
	Write-Output "OneDrive Devredisi..."
...
Function EnableOneDrive {
	Write-Output "OneDrive Aktif!"
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\OneDrive" -Name "DisableFileSyncNGSC" -ErrorAction SilentlyContinue
}

# Uninstall OneDrive - Not applicable to Server
Function UninstallOneDrive {
	Write-Output "OneDrive Siliniyor..."
...
Function InstallOneDrive {
	Write-Output "OneDrive Yukleniyor!"
	$onedrive = "$env:SYSTEMROOT\SysWOW64\OneDriveSetup.exe"
	If (!(Test-Path $onedrive)) {
		$onedrive = "$env:SYSTEMROOT\System32\OneDriveSetup.exe"
	}
